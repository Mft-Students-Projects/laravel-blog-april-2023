                                ...
                                @foreach($result_news as $news)
                                    ...
                                    <div class="col-lg-4">
                                        <div class="post-entry-1 border-bottom">
                                            ...
                                            <div class="post-meta"><span class="date"></span> <span class="mx-1">&bullet;</span> <span>{{\Morilog\Jalali\CalendarUtils::strftime('Y/m/d ساعت H:i', strtotime($news->created_at))}}</span></div>
