            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-right pull-left"></i>
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="{{route("categories.index")}}"><i class="fa fa-circle-o"></i> لیست</a></li>
                        <li><a href="{{route("categories.create")}}"><i class="fa fa-circle-o"></i> افزودن</a></li>
                    </ul>
                </li>
                ...
                <li class="treeview">
                    <a href="{{route("news.index")}}">
                        <i class="fa fa-dashboard"></i> <span>خبر</span>
                        <span class="pull-left-container">
              <i class="fa fa-angle-right pull-left"></i>
            </span>
                    </a>
                    <ul class="treeview-menu">
                        <li class="active"><a href="{{route("news.index")}}"><i class="fa fa-circle-o"></i> لیست</a></li>
                        <li><a href="{{route("news.create")}}"><i class="fa fa-circle-o"></i> افزودن</a></li>
                    </ul>
                </li>
                ...
                <li class="treeview">
                    <a href="{{route("reporters.index")}}">
                        <i class="fa fa-dashboard"></i> <span>خبرنگار</span>
                        <span class="pull-left-container">
              <i class="fa fa-angle-right pull-left"></i>
            </span>
                    </a>
                    <ul class="treeview-menu">
                        <li class="active"><a href="{{route("reporters.index")}}"><i class="fa fa-circle-o"></i> لیست</a></li>
                        <li><a href="{{route("reporters.create")}}"><i class="fa fa-circle-o"></i> افزودن</a></li>
                    </ul>
                </li>
